...
const compareBoolableValues = (value, value1) => {
	return (isFalse(value) && isFalse(value1)) || (isTrue(value) && isTrue(value1));
};
...
export { isTrue, isFalse, compareBoolableValues, checkBoolableValue, getCurrentDate, formatDate, dateFormat, dateAddition };
